from models.odefunc import ODEfunc, ODEnet
from models.normalization import MovingBatchNorm1d
from models.cnf import CNF, SequentialFlow
...
def get_cnf(args, input_dim, hidden_dims, context_dim, num_blocks, conditional):
    hidden_dims = tuple(map(int, hidden_dims.split("-")))
    model = build_model(args, input_dim, hidden_dims, context_dim, num_blocks, conditional).cuda()
